<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <a class="btn btn-success mb-4" href="<?= base_url('admin/dosen'); ?>">Semua Data Dosen Peserta / User</a>
                </div>
                <div class="col-sm-3">
                    <form action="<?= base_url('admin/dosen'); ?>" method="get">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addDosenLabel">Tambah Dosen Peserta / User</h5>
    ...
    <?php foreach ($dosen as $d) : ?>
        <div class="modal fade" id="hapusdosen<?= $d['id_dosen']; ?>" tabindex="-1" role="dialog" aria-labelledby="hapusDosenLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="hapusDosenLabel">Hapus Dosen Peserta / User</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
