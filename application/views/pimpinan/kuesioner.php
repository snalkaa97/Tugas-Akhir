<div class="container-fluid">
    ...
    <form action="<?= base_url('pimpinan/input_nilai'); ?>" method="post">
        ...
        ?>
        <h5>Kesungguhan Dalam Mempersiapkan Perkuliahan</h5>
        ...
        <h5 class="mt-4">Kemampuan Membimbing Mahasiswa</h5>
        <div class="form-check form-check-inline">
        ...
        <h5 class="mt-4">Penguasaan Bidang Keahlian yang Menjadi Tugas Pokoknya</h5>
        <div class="form-check form-check-inline">
        ...
        <h5 class="mt-4">Kewibawaan Sebagai Pribadi Dosen</h5>
        <div class="form-check form-check-inline">
        ...
        <h5 class="mt-4">Mudah Bergaul di Kalangan Sejawat, Karyawan, dan Mahasiswa</h5>
        <div class="form-check form-check-inline">
